...
from BusinessMiddleware.SystemManagement.ConfigManagement.ConfigPancreas import ConfigPancreas


class Pancreas_Seg(BaseService):
    def __init__(self, modelPath:str, deviceId:str):
        ...
        self.thNMSIou = 0.7
        self.confThres = 0.25
        self.list_classes=list(ConfigPancreas.REGIONS.values())
